...
public class CRUD {
    ...
    public ResultSet cariData(String id){ 
        CRUDquery = "select * from siswa where id like '%" + id + "%' or nama "+ "like '%" + id + "%'" ;
//        CRUDquery = "select * from siswa where id='"+id+"'" ;
        try{
            CRUDstat = CRUDkoneksi.createStatement();
            CRUDhasil = CRUDstat.executeQuery(CRUDquery);
        } catch (Exception e){
    ...
    public ResultSet hitungData(){
        CRUDquery = "select count(*) from siswa";
        try{
            CRUDstat = CRUDkoneksi.createStatement();
            CRUDhasil = CRUDstat.executeQuery(CRUDquery);
        } catch (Exception e){
